...
export const PLATFORMS: Platform[] = [
  ...
  },
  {
    ...
    ranges: [
      ...
      // Extra Cloudflare ranges (Spectrum, WARP, Argo Tunnel, Workers)
      { cidr: '45.128.0.0/13', region: 'CF Spectrum' },
      { cidr: '45.136.0.0/14', region: 'CF Spectrum' },
      { cidr: '45.140.0.0/15', region: 'CF Spectrum' },
      { cidr: '45.142.0.0/16', region: 'CF Spectrum' },
      { cidr: '5.10.0.0/16', region: 'CF Other' },
      { cidr: '162.159.0.0/16', region: 'CF Workers' },
      { cidr: '198.41.48.0/20', region: 'CF Global' },
      { cidr: '198.41.64.0/20', region: 'CF Global' },
      { cidr: '198.41.80.0/22', region: 'CF Global' },
      { cidr: '198.41.84.0/22', region: 'CF Global' },
      { cidr: '198.41.88.0/22', region: 'CF Global' },
      { cidr: '198.41.92.0/22', region: 'CF Global' },
      { cidr: '198.41.96.0/20', region: 'CF Global' },
    ],
  },
  {
    id: 'cloudflare-warp',
  ...
  },
  {
    ...
    ranges: [
      ...
      { cidr: '140.248.64.0/18', region: 'APAC' },
      { cidr: '140.248.128.0/17', region: 'Global' },
      { cidr: '146.75.0.0/17', region: 'Global' },
